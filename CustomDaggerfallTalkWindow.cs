      ...
      : base(uiManager)
        ...
        private void UpdateCustomNPCPortrait()
        {
            ...
            if (customNpc != null)
            {
                ...
                else if (customNpc.Data.billboardArchiveIndex == 182 && customNpc.Data.billboardRecordIndex == 21)
                {
                    recordIndex = 440;
                    Debug.Log($"Forced portrait selection: Archive 357, Record 1 -> CommonFaces, Record Index: {recordIndex}");
                }
                ...
                else if (customNpc.Data.billboardArchiveIndex == 184 && customNpc.Data.billboardRecordIndex == 9)
                {
                    recordIndex = 144;
                    Debug.Log($"Forced portrait selection: Archive 357, Record 1 -> CommonFaces, Record Index: {recordIndex}");
                }
